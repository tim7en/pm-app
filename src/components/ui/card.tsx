...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-xl border shadow-premium backdrop-blur-sm transition-all duration-300 hover:shadow-premium-xl hover:-translate-y-0.5",
        className
      )}
      {...props}
    />
