                ...
                <div className="space-y-4">
                  <Alert className="border-green-200 bg-green-50">
                    ...
                    <AlertDescription className="text-green-800">
                      {(getCurrentDemo().example as any)?.message || 'No message available'}
                    </AlertDescription>
                  </Alert>
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="p-3 bg-blue-50 rounded">
                ...
                <div className="space-y-4">
                  <Alert className="border-orange-200 bg-orange-50">
                    ...
                    <AlertDescription className="text-orange-800">
                      {(getCurrentDemo().example as any)?.reminder || 'No reminder available'}
                    </AlertDescription>
                  </Alert>
                  <div className="text-sm text-gray-600 p-3 bg-gray-50 rounded">
                    <strong>Manager Notification:</strong><br />
                    {(getCurrentDemo().example as any)?.managerNotification || 'No notification available'}
                  </div>
